    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-4 mt-10 lg:py-10 lg:px-20">
        <div className='text-left lg:col-span-2 mb-10 lg:mb-0 mx-auto lg:mx-0'>
          <p className='mb-10 max-w-prose'>I have no idea what I&aposm doing and to be completely honest I had to Google “how to write an introduction about yourself.” It was ineffective, to say the least. So, I&aspos;ll just skip the pleasantries and jump straight into it if that&aspos;s okay with you. My name is Magdalena Moseley though I typically go by Maggie. I&aspos;ve always said that when I become rich and famous I&aspos;ll one-name it and go by Magdalena (like the queen herself Zendaya) but as that hasn&aspos;t happened yet I&aspos;ll just stick with Maggie for now.
          </p>
          ...
          <p className='mb-10 max-w-prose'>
            Don&aspos;t worry we&aspos;ll talk more about my career goals and aspirations later. For now, more about who I am, what I&aspos;m doing, and why you&aspos;re reading this. First: who am I? Well, Maggie, as you know. I am a 19-year-old girl in today&aspos;s society, and yes that means that I have parasocial relationships with celebrities and am a big proponent of taking care of our mental health. It also means that I have no idea what I am doing on a typical daily basis and have little sense of who I am which is why this introduction has not been a breeze to write. So in light of that, let&aspos;s move on! What am I doing? Well, I am currently enrolled in UW&aspos;s exchange program which means that I will be spending the next semester studying abroad at the University of South Australia. But why are you reading this? Probably because you&aspos;re one of my family members wanting to know what I am up to (hi Dad). If you&aspos;re someone else then I have no idea why you&aspos;re reading this, go live your life. Kidding of course. Thanks for joining me! And to actually explain what this is that you are reading I should also tell you that I am a Gilman Scholar which means that I was awarded the Gilman International Scholarship for my semester abroad. Now the Gilman program requires that while abroad, or after I return, I take on a project that will not only spread the word about Gilman but that will spread the word about study abroad in general and all of its benefits. So that is what this is, my required project so that a government department would give me money! On a serious note though, I am truly very grateful for the help that Gilman has provided me and the opportunities that I have because of them.
          </p>
          <p className='max-w-prose'>
            I have chosen to write this blog because, to put it simply, I love writing (and also maybe it will gain a lot of traction and I&aspos;ll become a travel blogger, who&aspos;s to say?). The blog will be following me along on my journey. And I really have to mention that it has been brought to you by Alicia Thoney Headquarters, The ATHQ, and the lovely Alicia Thoney herself (I&aspos;m so lucky!). I hope to post a few times a month and for each post to have a different purpose. Some posts will detail the ins and outs and the ups and downs of the entire process of getting here, some will be focused on application advice or scholarship help, and others will simply be updates about my time here including everything that I am doing and everything that I am feeling. There is also a nifty photo gallery section and a link to my dedicated Spotify Playlist (feel honored that I&aspos;m sharing that with you because that is quite the privilege) So, if you&aspos;re a prospective study abroad student or just someone who is intrigued, or my parents, then stay tuned!
          </p>
        </div>
