...
export default function HeroAbout() {
  return (
    <div className='sm:mt-10 lg:px-20'>
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 mx-auto">
        <div className="flex mx-auto lg:col-span-1">
          <Image src="/images/magdelana-sq.png" alt="Magdelana Moseley" width={500} height={200} className=" object-cover mb-5 lg:mb-0 mt-5" />
        </div>
